        ...
        <div className="featured-drinks-grid">
          ...
          <div className="featured-drink-card">
            ...
            <div className="featured-drink-content">
              ...
              <button className="featured-btn" onClick={() => router.push('/menupage')}>Order chai</button>
            </div>
          </div>
          ...
          <div className="featured-drink-card">
            ...
            <div className="featured-drink-content">
              ...
              <button className="featured-btn" onClick={() => router.push('/menupage')}>Order now</button>
            </div>
          </div>
  ...
  <div className="featured-coconut-grid">
    ...
    <div className="featured-coconut-card">
      ...
      <div className="featured-coconut-content">
        ...
        <button className="featured-coconut-btn left-btn" onClick={() => router.push('/menupage')}>Start an order</button>
      </div>
    </div>
    ...
    <div className="featured-coconut-card">
      ...
      <div className="featured-coconut-content">
        ...
        <button className="featured-coconut-btn right-btn" onClick={() => router.push('/menupage')}>Order Toasted Coconut</button>
      </div>
    </div>
...
<section className="featured-food-banner">
  ...
  <div className="featured-food-banner-content">
    ...
    <button className="featured-food-banner-btn" onClick={() => router.push('/menupage')}>Order now</button>
  </div>
</section>
