  ...
  return (
    <>
      ...
      <section className="green-bar">
        ...
        <button className="start-order-btn">Start an order</button>
      </section>
      ...
      <section className="main-section">
        ...
        <div className="right-text">
          ...
          <button className="btn-outline-white">Order Dubai chocolate</button>
        </div>
      </section>
      ...
      <section className="roller-section">
        <div className="roller-left">
          ...
          <button className="roller-btn">Explore caramel protein</button>
        </div>
      ...
      <section className="main-section">
        ...
        <div className="right-text holiday-green">
          ...
          <button className="btn-outline-white">Order in the app</button>
        </div>
      </section>
      ...
      <section className="free-drink-section">
        <div className="free-drink-text">
          ...
          <button className="free-drink-btn">Join now</button>
        </div>
      ...
      <section className="free-cheer-section">
        <div className="free-cheer-text">
          ...
          <button className="free-cheer-btn">Order now</button>
        </div>
