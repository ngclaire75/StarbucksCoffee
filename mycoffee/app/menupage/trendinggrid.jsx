      ...
      <div style={{ marginBottom: 8 }}>
        ...
        <div style={{ position: 'relative', display: 'inline-block' }}>
          ...
          >
            ...
            <span style={{ fontSize: 11, color: '#000009de', fontWeight: 700, display: 'inline-block', transform: dropdownOpen ? 'rotate(180deg)' : 'rotate(0deg)', transition: 'transform 0.22s ease' }}>
              ⮟
            </span>
          </button>
