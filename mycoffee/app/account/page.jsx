...
// Resize + crop image to square, returns base64 JPEG
...
export default function AccountPage() {
  ...
  async function capturePhoto() {
    ...
    ctx.drawImage(v, sx, sy, side, side, 0, 0, 200, 200);
    const base64 = canvas.toDataURL('image/jpeg', 0.82);
    stopWebcam();
    await saveAvatarImage(base64);
  }
  ...
  if (loading) {
    return (<><WhiteNav /><div className="acct-loading">Loading your account…</div></>);
  }
        ...
        <aside className="acct-sidebar">
          ...
          <div className="acct-avatar-section">
            <div
              ...
              onClick={() => { setShowAvatarMenu(v => !v); setAvatarMsg(''); }}
