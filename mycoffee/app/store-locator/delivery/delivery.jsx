  ...
  return (
    <>
      ...
      <div className={`dd-cart-drawer ${open ? "dd-cart-drawer--open" : ""}`} role="dialog" aria-label="Cart">
        <div className="dd-cart-inner">
          <div className="dd-cart-hd">
            <h2 className="dd-cart-title">Your Order</h2>
            {totalCount > 0 && (
              <span className="dd-cart-count-badge">{totalCount} {totalCount === 1 ? "ITEM" : "ITEMS"}</span>
            )}
            <button className="dd-icon-btn" onClick={onClose} aria-label="Close cart" style={{marginLeft: "auto"}}><Ic.Close /></button>
          </div>
            ...
            <>
              <div className="dd-cart-items">
                {cartItems.map(ci => (
                  <div key={ci.id} className="dd-cart-item">
                    <div className="dd-cart-item-qty-circle">{ci.qty}</div>
                    <div className="dd-cart-item-info">
                      <p className="dd-cart-item-name">{ci.name}</p>
                      <span className="dd-cart-item-size-badge">{getSize(ci.id)}</span>
                      <div className="dd-cart-item-bottom">
                        ...
                        <div className="dd-cart-item-actions">
                          <button onClick={() => {}}>Edit</button>
                          <span className="dd-cart-item-actions-sep">|</span>
                          <button onClick={() => onCart({ ...ci, delta: -1 })}>Remove</button>
                        </div>
                      </div>
                    </div>
              ...
              <div className="dd-cart-ft">
                <div className="dd-cart-totals">
                  ...
                  <div className="dd-cart-total"><span>Total</span><span>${total.toFixed(2)}</span></div>
                </div>
