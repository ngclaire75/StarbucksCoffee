...
export function GlobePanel({ isOpen, onClose, globeBtnRef }) {
  ...
  const regions = [
    { name: "Canada", langs: [{ label: "English" }, { label: "Français" }] },
    { name: "USA", langs: [{ label: "English" }] },
    { name: "EMEA", langs: [{ label: "English", ext: true }] },
    {
      name: "Latin America",
      langs: [
        { label: "English", ext: true },
        { label: "Español", ext: true },
        { label: "Português", ext: true },
      ],
    },
    { name: "Asia", langs: [{ label: "English", ext: true }] },
    { name: "Japan", langs: [{ label: "日本語", ext: true }] },
  ];
